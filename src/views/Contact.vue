        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 shadow-xl">
          ...
          <div class="relative overflow-hidden py-10 px-6 bg-indigo-700 sm:px-10 xl:p-12">
            ...
            <dl class="mt-8 space-y-6">
              ...
              <dd class="flex text-base text-indigo-50">
                ...
                <span class="ml-3"><a href="tel:07817925028">07817 925028</a></span>
              </dd>
              <dt><span class="sr-only">Email</span></dt>
              <dd class="flex text-base text-indigo-50">
                <MailIcon class="flex-shrink-0 w-6 h-6 text-indigo-200" aria-hidden="true" />
                <span class="ml-3"><a href="mailto:jo@treadingtheboards.wales">jo@treadingtheboards.wales</a></span>
              </dd>
            </dl>
            <p class="mt-8 mb-5 text-white">Follow and contact us on social media</p>
            <ul class="flex space-x-8" role="list">
              <li>
                <a class="text-indigo-200 hover:text-indigo-100" target="_BLANK" href="http://www.facebook.com/treadingtheboardsstageschool">
              ...
              <li>
                <a class="text-indigo-200 hover:text-indigo-100" target="_BLANK" href="https://www.instagram.com/treadingtheboardsvog">
          ...
          <div class="py-10 px-6 sm:px-10 lg:col-span-2 xl:p-12">
            ...
            <form action="https://fabform.io/f/KopHggl" method="post" name="contact" class="mt-6 grid grid-cols-1 gap-y-6 sm:grid-cols-2 sm:gap-x-8">
              <div>
                <label for="name" class="block text-sm font-medium text-gray-900">Parent name</label>
                <div class="mt-1">
                  <input required type="text" name="name" id="name" autocomplete="name" class="py-3 px-4 block w-full shadow-sm text-gray-900 focus:border-indigo-500 border border-gray-300 rounded-md" />
                </div>
              </div>
              <div>
                <div class="flex justify-between">
                  <label for="child" class="block text-sm font-medium text-gray-900">Child name</label>
                  <span id="child-optional" class="text-sm text-gray-500">Optional</span>
                </div>
                <div class="mt-1">
                  <input type="text" name="child" id="sttudent" class="py-3 px-4 block w-full shadow-sm text-gray-900 focus:border-indigo-500 border border-gray-300 rounded-md" />
                </div>
              </div>
              <div>
                <label for="email" class="block text-sm font-medium text-gray-900">Email</label>
                <div class="mt-1">
                  <input required id="email" name="email" type="email" autocomplete="email" class="py-3 px-4 block w-full shadow-sm text-gray-900 focus:border-indigo-500 border border-gray-300 rounded-md" />
                </div>
              </div>
              <div>
                <div class="flex justify-between">
                ...
                <div class="mt-1">
                  <input type="text" name="phone" id="phone" autocomplete="tel" class="py-3 px-4 block w-full shadow-sm text-gray-900 focus:border-indigo-500 border border-gray-300 rounded-md" aria-describedby="phone-optional" />
                </div>
              </div>
              <div class="sm:col-span-2">
                <div>
                  <label for="enquiry" class="block text-sm font-medium text-gray-900">Enquiry type</label>
                  <div class="mt-1">
                    <select required name="enquiry" id="enquiry" class="py-3 px-4 block w-full shadow-sm text-gray-900 focus:border-indigo-500 border border-gray-300 rounded-md">
                      <option value="" selected disabled hidden>Please select an option</option>
                      <option value="class information">Classes</option>
                ...
                <div class="mt-1">
                  <textarea required id="message" name="message" rows="4" class="py-3 px-4 block w-full shadow-sm text-gray-900 focus:border-indigo-500 border border-gray-300 rounded-md" aria-describedby="message-max" />
                </div>
              </div>
              <div class="sm:col-span-2 sm:flex sm:justify-end">
                <button type="submit" class="mt-2 w-full inline-flex items-center justify-center px-6 py-3 border border-transparent rounded-md shadow-sm text-base font-medium text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 sm:w-auto">
                  Submit
                </button>
              </div>
            </form>
